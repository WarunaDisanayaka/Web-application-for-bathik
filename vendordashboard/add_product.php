...
<?php
   ...
   // Validate quantity
   if (empty($product_qty) || !is_numeric($product_qty)) {
       $errors[] = 'Invalid quantity. Please enter a valid quantity.';
   }
   
   // Validate size
   if (empty($product_size) || $product_size == 'Choose size...') {
       $errors[] = 'Please select a product size.';
   }
                     ...
                     <div class="col-lg-6 mb-4">
                        <form  method="POST" action="add_product.php" enctype="multipart/form-data">
                           ...
                           <div class="form-group">
                              ...
                              <input type="number" class="form-control" id="product-qty" name="product-qty" placeholder="Enter quantity">
                           </div>
                           <div class="form-group">
                              <label for="product-size">Size</label>
                              <select class="form-control" id="product-size" name="product-size">
