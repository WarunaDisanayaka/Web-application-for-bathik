...
<body id="page-top">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><?php if ( $row['active']==0){echo 'Not Confirmed';}else{echo 'Confirmed';} ?></td>
      <td>
      <button class="btn btn-success"><a href="stores.php?id=<?php echo $row['store_id'];?>"style="text-decoration: none;"> <?php if ($row['active']==1) {echo "Activated";}else {echo "Activate";} ?></a></button>
    </td>
    </tr>
